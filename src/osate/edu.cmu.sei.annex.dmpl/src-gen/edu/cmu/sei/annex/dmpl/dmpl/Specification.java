...
public interface Specification extends EObject
{
   ...
   * @see #setSpec(SpecNoAttr)
   * @see edu.cmu.sei.annex.dmpl.dmpl.DmplPackage#getSpecification_Spec()
   * @model containment="true"
   * @generated
   */
  SpecNoAttr getSpec();
  ...
  /**
   * Sets the value of the '{@link edu.cmu.sei.annex.dmpl.dmpl.Specification#getSpec <em>Spec</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
