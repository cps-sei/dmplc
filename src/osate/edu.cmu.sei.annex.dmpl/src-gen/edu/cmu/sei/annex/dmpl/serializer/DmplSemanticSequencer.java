...
public class DmplSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == DmplPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case DmplPackage.ASSIGNMENT_STMT:
				sequence_Stmt(context, (AssignmentStmt) semanticObject); 
				return; 
	...
	protected void sequence_FnBody(EObject context, FnBody semanticObject) {
		if(errorAcceptor != null) {
			...
			if(transientValues.isValueTransient(semanticObject, DmplPackage.Literals.FN_BODY__STMT_LIST) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, DmplPackage.Literals.FN_BODY__STMT_LIST));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getFnBodyAccess().getVarInitListVarInitListParserRuleCall_1_0(), semanticObject.getVarInitList());
		feeder.accept(grammarAccess.getFnBodyAccess().getStmtListStmtListParserRuleCall_2_0(), semanticObject.getStmtList());
		feeder.finish();
	}
	 ...
	 */
	protected void sequence_Stmt(EObject context, AssignmentStmt semanticObject) {
		if(errorAcceptor != null) {
		...
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getStmtAccess().getVariableLValParserRuleCall_1_1_0(), semanticObject.getVariable());
		feeder.accept(grammarAccess.getStmtAccess().getValueExprParserRuleCall_1_3_0(), semanticObject.getValue());
		feeder.finish();
	}
	...
	protected void sequence_Stmt(EObject context, FadnpStmt semanticObject) {
		...
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getStmtAccess().getNode1TIDENTIFIERTerminalRuleCall_7_3_0(), semanticObject.getNode1());
		feeder.accept(grammarAccess.getStmtAccess().getNode2TIDENTIFIERTerminalRuleCall_7_5_0(), semanticObject.getNode2());
		feeder.accept(grammarAccess.getStmtAccess().getStmtStmtParserRuleCall_7_7_0(), semanticObject.getStmt());
		feeder.finish();
	}
	...
	protected void sequence_Stmt(EObject context, ForAllStmt semanticObject) {
		...
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getStmtAccess().getNameForAllFunctionParserRuleCall_6_1_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getStmtAccess().getNodeTIDENTIFIERTerminalRuleCall_6_3_0(), semanticObject.getNode());
		feeder.accept(grammarAccess.getStmtAccess().getStmtStmtParserRuleCall_6_5_0(), semanticObject.getStmt());
		feeder.finish();
	}
	...
	protected void sequence_Stmt(EObject context, NestedStmt semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, DmplPackage.Literals.NESTED_STMT__STMT_LIST) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, DmplPackage.Literals.NESTED_STMT__STMT_LIST));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getStmtAccess().getStmtListStmtListParserRuleCall_0_2_0(), semanticObject.getStmtList());
		feeder.finish();
	}
	...
	protected void sequence_Stmt(EObject context, ReturnValueStmt semanticObject) {
		...
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getStmtAccess().getValueExprParserRuleCall_4_2_0(), semanticObject.getValue());
		feeder.finish();
	}
	...
	protected void sequence_Stmt(EObject context, SimpleStmt semanticObject) {
		...
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getStmtAccess().getNameSimpleStmtKeywordParserRuleCall_3_1_0(), semanticObject.getName());
		feeder.finish();
	}
