...
(
    ...
    { 
        $current = $this_CallExpr_31.current; 
        afterParserOrEnumRuleCall();
    }
	otherlv_32=';' 
    {
...
)(	otherlv_40='forall_distinct_node_pair' 
    {
...
(
(
		lv_node1_43_0=RULE_TIDENTIFIER
		{
...
(
(
		lv_node2_45_0=RULE_TIDENTIFIER
		{
