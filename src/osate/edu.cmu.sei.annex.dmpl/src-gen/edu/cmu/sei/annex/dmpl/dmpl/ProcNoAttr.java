 ...
 * </p>
 * <ul>
 *   <li>{@link edu.cmu.sei.annex.dmpl.dmpl.ProcNoAttr#isOverride <em>Override</em>}</li>
...
public interface ProcNoAttr extends AttributableElement
{
   ...
   * @see edu.cmu.sei.annex.dmpl.dmpl.DmplPackage#getProcNoAttr_Override()
   * @model
   * @generated
   */
  boolean isOverride();
  ...
  /**
   * Sets the value of the '{@link edu.cmu.sei.annex.dmpl.dmpl.ProcNoAttr#isOverride <em>Override</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
