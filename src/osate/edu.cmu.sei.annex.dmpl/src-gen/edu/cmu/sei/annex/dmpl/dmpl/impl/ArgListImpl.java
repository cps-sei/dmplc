 ...
 * </p>
 * <ul>
 *   <li>{@link edu.cmu.sei.annex.dmpl.dmpl.impl.ArgListImpl#getArgs <em>Args</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArgListImpl extends MinimalEObjectImpl.Container implements ArgList
{
  ...
  {
    return DmplPackage.Literals.ARG_LIST;
  }
  ...
  public EList<Expr> getArgs()
  {
    if (args == null)
    {
      args = new EObjectContainmentEList<Expr>(Expr.class, this, DmplPackage.ARG_LIST__ARGS);
    }
    return args;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case DmplPackage.ARG_LIST__ARGS:
