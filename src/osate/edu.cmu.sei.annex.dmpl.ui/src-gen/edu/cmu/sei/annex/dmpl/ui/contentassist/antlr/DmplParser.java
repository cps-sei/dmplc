		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getVarAsgnAccess().getAlternatives_0_1(), "rule__VarAsgn__Alternatives_0_1");
					...
					put(grammarAccess.getVarAsgnAccess().getGroup_0_1_0(), "rule__VarAsgn__Group_0_1_0__0");
					put(grammarAccess.getVarAsgnAccess().getGroup_0_1_1(), "rule__VarAsgn__Group_0_1_1__0");
					...
					put(grammarAccess.getVarAsgnAccess().getVarAssignment_0_1_0_0(), "rule__VarAsgn__VarAssignment_0_1_0_0");
					put(grammarAccess.getVarAsgnAccess().getInputAssignment_0_1_1_0(), "rule__VarAsgn__InputAssignment_0_1_1_0");
					put(grammarAccess.getVarAsgnAccess().getVarAssignment_0_1_1_1(), "rule__VarAsgn__VarAssignment_0_1_1_1");
					put(grammarAccess.getVarAsgnAccess().getExprAssignment_0_2(), "rule__VarAsgn__ExprAssignment_0_2");
					...
					put(grammarAccess.getVarAsgnAccess().getFnBodyAssignment_1_2(), "rule__VarAsgn__FnBodyAssignment_1_2");
