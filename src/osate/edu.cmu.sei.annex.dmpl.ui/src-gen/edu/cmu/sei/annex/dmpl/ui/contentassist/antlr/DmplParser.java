		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getStmtAccess().getAlternatives_7_1(), "rule__Stmt__Alternatives_7_1");
					...
					put(grammarAccess.getFnBodyAccess().getStmtListAssignment_2(), "rule__FnBody__StmtListAssignment_2");
					...
					put(grammarAccess.getStmtAccess().getVariableAssignment_1_1(), "rule__Stmt__VariableAssignment_1_1");
					put(grammarAccess.getStmtAccess().getValueAssignment_1_3(), "rule__Stmt__ValueAssignment_1_3");
					...
					put(grammarAccess.getStmtAccess().getNameAssignment_3_1(), "rule__Stmt__NameAssignment_3_1");
					put(grammarAccess.getStmtAccess().getValueAssignment_4_2(), "rule__Stmt__ValueAssignment_4_2");
					put(grammarAccess.getStmtAccess().getNameAssignment_6_1(), "rule__Stmt__NameAssignment_6_1");
					put(grammarAccess.getStmtAccess().getNodeAssignment_6_3(), "rule__Stmt__NodeAssignment_6_3");
					put(grammarAccess.getStmtAccess().getStmtAssignment_6_5(), "rule__Stmt__StmtAssignment_6_5");
					put(grammarAccess.getStmtAccess().getNode1Assignment_7_3(), "rule__Stmt__Node1Assignment_7_3");
					put(grammarAccess.getStmtAccess().getNode2Assignment_7_5(), "rule__Stmt__Node2Assignment_7_5");
					put(grammarAccess.getStmtAccess().getStmtAssignment_7_7(), "rule__Stmt__StmtAssignment_7_7");
