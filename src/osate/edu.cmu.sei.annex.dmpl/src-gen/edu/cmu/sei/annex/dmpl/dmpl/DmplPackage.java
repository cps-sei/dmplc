...
public interface DmplPackage extends EPackage
{
   ...
   * @ordered
   */
  int COND_STMT__STMT = STMT_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int COND_STMT_FEATURE_COUNT = STMT_FEATURE_COUNT + 1;
   ...
   * @generated
   */
  int SIMPLE_STMT_KEYWORD_ENUM = 61;
