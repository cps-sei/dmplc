...
(
    ...
    { 
        $current = $this_CallExpr_22.current; 
        afterParserOrEnumRuleCall();
    }
	otherlv_23=';' 
    {
...
(
(
		lv_node1_34_0=RULE_TIDENTIFIER
		{
...
(
(
		lv_node2_36_0=RULE_TIDENTIFIER
		{
