...
public interface DmplPackage extends EPackage
{
   ...
   * @ordered
   */
  int NODE_NO_ATTR_FEATURE_COUNT = 1;
   ...
   * @generated
   */
  int SIMPLE_STMT_KEYWORD_ENUM = 60;
