 ...
 * </p>
 * <ul>
 *   <li>{@link edu.cmu.sei.annex.dmpl.dmpl.AttrList#getAttrs <em>Attrs</em>}</li>
 * </ul>
 *
 * @see edu.cmu.sei.annex.dmpl.dmpl.DmplPackage#getAttrList()
 * @model
 * @generated
 */
public interface AttrList extends EObject
{
   ...
   * @see edu.cmu.sei.annex.dmpl.dmpl.DmplPackage#getAttrList_Attrs()
