...
:
(
{ before(grammarAccess.getNodeBodyAccess().getElementsProcedureParserRuleCall_1_0()); }
	ruleProcedure{ after(grammarAccess.getNodeBodyAccess().getElementsProcedureParserRuleCall_1_0()); }
)
