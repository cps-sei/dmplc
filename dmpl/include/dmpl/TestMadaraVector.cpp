...
int main()
{
  ...
  std::cout << "Existing Reference StaticArray: " << exref_array[1][2][3].valid() << std::endl;
  std::cout << "Existing Reference StaticArray: " << exref_array[1][2][1].valid() << std::endl;
  ...
  std::cout << "Reference StaticArray: " << ref_array[1][2][3] << std::endl;
  std::cout << "Reference StaticArray: " << ref_array[1][2][3].get_name() << std::endl;
  ref_array[1][2][3] += 1;
  std::cout << "Reference StaticArray: " << ref_array[1][2][3] << std::endl;
