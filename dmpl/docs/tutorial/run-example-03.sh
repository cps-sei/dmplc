...
function cleanup {
    ...
    #kill nodes and VREP
    killall example-03 vrep vrep.sh
...
#compile tutorial 2
rm -f example-03 example-03.cpp
...
make example-03 GRIDSIZE=$GRIDSIZE TopY=$TopY LeftX=$LeftX BottomY=$BottomY RightX=$RightX
...
#start the nodes
./example-03 --platform vrep::::0.2 --id 1 --var_x $((IX+2)) --var_y $((IY+2)) &> $OUTDIR/node1.out &
./example-03 --platform vrep::::0.2 --id 2 --var_x $((IX)) --var_y $((IY+2)) &> $OUTDIR/node2.out &
./example-03 --platform vrep::::0.2 --id 3 --var_x $((IX-2)) --var_y $((IY+2)) &> $OUTDIR/node3.out &
./example-03 --platform vrep::::0.2 --id 4 --var_x $((IX-2)) --var_y $((IY)) &> $OUTDIR/node4.out &
./example-03 --platform vrep::::0.2 --id 5 --var_x $((IX-2)) --var_y $((IY-2)) &> $OUTDIR/node5.out &
./example-03 --platform vrep::::0.2 --id 6 --var_x $((IX)) --var_y $((IY-2)) &> $OUTDIR/node6.out &
./example-03 --platform vrep::::0.2 --id 7 --var_x $((IX+2)) --var_y $((IY-2)) &> $OUTDIR/node7.out &
./example-03 --platform vrep::::0.2 --id 8 --var_x $((IX+2)) --var_y $((IY)) &> $OUTDIR/node8.out &
./example-03 --platform vrep::::0.2 --id 0 --var_x $IX --var_y $IY --var_xt $FX --var_yt $FY &> $OUTDIR/node0.out &
