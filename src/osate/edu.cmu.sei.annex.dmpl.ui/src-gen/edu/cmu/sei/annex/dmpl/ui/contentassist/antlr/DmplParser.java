		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getProgramElementNoTargetAccess().getAlternatives_2_1(), "rule__ProgramElementNoTarget__Alternatives_2_1");
					put(grammarAccess.getAttributableNodeOrProcedureAccess().getAlternatives(), "rule__AttributableNodeOrProcedure__Alternatives");
					put(grammarAccess.getAttributableNodeOrProcedureAccess().getAlternatives_0_1(), "rule__AttributableNodeOrProcedure__Alternatives_0_1");
					put(grammarAccess.getAttributableNodeOrProcedureAccess().getAlternatives_0_3(), "rule__AttributableNodeOrProcedure__Alternatives_0_3");
					...
					put(grammarAccess.getProcedureAccess().getExternAlternatives_0_2_0(), "rule__Procedure__ExternAlternatives_0_2_0");
					put(grammarAccess.getProcedureAccess().getPureAlternatives_0_3_0(), "rule__Procedure__PureAlternatives_0_3_0");
					put(grammarAccess.getProcedureAccess().getAlternatives_0_6(), "rule__Procedure__Alternatives_0_6");
					put(grammarAccess.getProcedureAccess().getExternAlternatives_1_2_0(), "rule__Procedure__ExternAlternatives_1_2_0");
					put(grammarAccess.getProcedureAccess().getPureAlternatives_1_3_0(), "rule__Procedure__PureAlternatives_1_3_0");
					put(grammarAccess.getProcedureAccess().getAlternatives_1_9(), "rule__Procedure__Alternatives_1_9");
					...
					put(grammarAccess.getAssignmentOrIncrementStmtAccess().getAlternatives(), "rule__AssignmentOrIncrementStmt__Alternatives");
					put(grammarAccess.getIncrementStmtAccess().getAlternatives(), "rule__IncrementStmt__Alternatives");
					...
					put(grammarAccess.getProgramElementNoTargetAccess().getGroup_2(), "rule__ProgramElementNoTarget__Group_2__0");
					put(grammarAccess.getProgramElementNoTargetAccess().getGroup_3(), "rule__ProgramElementNoTarget__Group_3__0");
					...
					put(grammarAccess.getProcedureAccess().getGroup_1_7(), "rule__Procedure__Group_1_7__0");
					put(grammarAccess.getProcedureAccess().getGroup_1_7_1(), "rule__Procedure__Group_1_7_1__0");
					...
					put(grammarAccess.getIncrementStmtAccess().getGroup_0(), "rule__IncrementStmt__Group_0__0");
					put(grammarAccess.getIncrementStmtAccess().getGroup_1(), "rule__IncrementStmt__Group_1__0");
					put(grammarAccess.getInitAssignmentStmtAccess().getGroup(), "rule__InitAssignmentStmt__Group__0");
					...
					put(grammarAccess.getTerminalExprAccess().getGroup_9(), "rule__TerminalExpr__Group_9__0");
					...
					put(grammarAccess.getProgramElementNoTargetAccess().getValueAssignment_2_4(), "rule__ProgramElementNoTarget__ValueAssignment_2_4");
					put(grammarAccess.getProgramElementNoTargetAccess().getAttrsAssignment_3_1(), "rule__ProgramElementNoTarget__AttrsAssignment_3_1");
					put(grammarAccess.getProgramElementNoTargetAccess().getElementAssignment_3_2(), "rule__ProgramElementNoTarget__ElementAssignment_3_2");
					...
					put(grammarAccess.getSpecificationAccess().getFunctionAssignment_0_6(), "rule__Specification__FunctionAssignment_0_6");
					put(grammarAccess.getSpecificationAccess().getNameAssignment_1_2(), "rule__Specification__NameAssignment_1_2");
					put(grammarAccess.getSpecificationAccess().getThresholdAssignment_1_5(), "rule__Specification__ThresholdAssignment_1_5");
					put(grammarAccess.getSpecificationAccess().getFunctionAssignment_1_7(), "rule__Specification__FunctionAssignment_1_7");
					put(grammarAccess.getSpecificationAccess().getNameAssignment_2_2(), "rule__Specification__NameAssignment_2_2");
					put(grammarAccess.getSpecificationAccess().getFunctionAssignment_2_4(), "rule__Specification__FunctionAssignment_2_4");
					put(grammarAccess.getNodeBodyElementAccess().getAttrsAssignment_2_1(), "rule__NodeBodyElement__AttrsAssignment_2_1");
					...
					put(grammarAccess.getRoleBodyElementAccess().getAttrsAssignment_2_1(), "rule__RoleBodyElement__AttrsAssignment_2_1");
					...
					put(grammarAccess.getProcedureAccess().getOverrideAssignment_0_1(), "rule__Procedure__OverrideAssignment_0_1");
					put(grammarAccess.getProcedureAccess().getExternAssignment_0_2(), "rule__Procedure__ExternAssignment_0_2");
					put(grammarAccess.getProcedureAccess().getPureAssignment_0_3(), "rule__Procedure__PureAssignment_0_3");
					put(grammarAccess.getProcedureAccess().getNameAssignment_0_5(), "rule__Procedure__NameAssignment_0_5");
					put(grammarAccess.getProcedureAccess().getFnBodyAssignment_0_6_1(), "rule__Procedure__FnBodyAssignment_0_6_1");
					put(grammarAccess.getProcedureAccess().getOverrideAssignment_1_1(), "rule__Procedure__OverrideAssignment_1_1");
					put(grammarAccess.getProcedureAccess().getExternAssignment_1_2(), "rule__Procedure__ExternAssignment_1_2");
					put(grammarAccess.getProcedureAccess().getPureAssignment_1_3(), "rule__Procedure__PureAssignment_1_3");
					put(grammarAccess.getProcedureAccess().getTypeAssignment_1_4(), "rule__Procedure__TypeAssignment_1_4");
					put(grammarAccess.getProcedureAccess().getNameAssignment_1_5(), "rule__Procedure__NameAssignment_1_5");
					put(grammarAccess.getProcedureAccess().getParamsAssignment_1_7_0(), "rule__Procedure__ParamsAssignment_1_7_0");
					put(grammarAccess.getProcedureAccess().getParamsAssignment_1_7_1_1(), "rule__Procedure__ParamsAssignment_1_7_1_1");
					put(grammarAccess.getProcedureAccess().getFnBodyAssignment_1_9_1(), "rule__Procedure__FnBodyAssignment_1_9_1");
					...
					put(grammarAccess.getStmtAccess().getAttrsAssignment_4_1(), "rule__Stmt__AttrsAssignment_4_1");
					...
					put(grammarAccess.getIncrementStmtAccess().getVarAssignment_0_0(), "rule__IncrementStmt__VarAssignment_0_0");
					put(grammarAccess.getIncrementStmtAccess().getVarAssignment_1_1(), "rule__IncrementStmt__VarAssignment_1_1");
					put(grammarAccess.getInitAssignmentStmtAccess().getTypeAssignment_0(), "rule__InitAssignmentStmt__TypeAssignment_0");
					put(grammarAccess.getInitAssignmentStmtAccess().getVariableAssignment_1(), "rule__InitAssignmentStmt__VariableAssignment_1");
					put(grammarAccess.getInitAssignmentStmtAccess().getValueAssignment_3(), "rule__InitAssignmentStmt__ValueAssignment_3");
					...
					put(grammarAccess.getTerminalExprAccess().getValueAssignment_4_1(), "rule__TerminalExpr__ValueAssignment_4_1");
					put(grammarAccess.getTerminalExprAccess().getOperatorAssignment_6_1(), "rule__TerminalExpr__OperatorAssignment_6_1");
					put(grammarAccess.getTerminalExprAccess().getOperandAssignment_6_2(), "rule__TerminalExpr__OperandAssignment_6_2");
					put(grammarAccess.getTerminalExprAccess().getFunctionAssignment_7_1(), "rule__TerminalExpr__FunctionAssignment_7_1");
					put(grammarAccess.getTerminalExprAccess().getFirstArgAssignment_7_3(), "rule__TerminalExpr__FirstArgAssignment_7_3");
					put(grammarAccess.getTerminalExprAccess().getSecondArgAssignment_7_5(), "rule__TerminalExpr__SecondArgAssignment_7_5");
					put(grammarAccess.getTerminalExprAccess().getExprAssignment_9_2(), "rule__TerminalExpr__ExprAssignment_9_2");
					put(grammarAccess.getCallExprAccess().getNamespacesAssignment_0_0(), "rule__CallExpr__NamespacesAssignment_0_0");
