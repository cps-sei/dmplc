		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getStmtAccess().getAlternatives_8_1(), "rule__Stmt__Alternatives_8_1");
					...
					put(grammarAccess.getStmtAccess().getNameAssignment_4_1(), "rule__Stmt__NameAssignment_4_1");
					put(grammarAccess.getStmtAccess().getValueAssignment_5_2(), "rule__Stmt__ValueAssignment_5_2");
					put(grammarAccess.getStmtAccess().getNameAssignment_7_1(), "rule__Stmt__NameAssignment_7_1");
					put(grammarAccess.getStmtAccess().getNodeAssignment_7_3(), "rule__Stmt__NodeAssignment_7_3");
					put(grammarAccess.getStmtAccess().getStmtAssignment_7_5(), "rule__Stmt__StmtAssignment_7_5");
					put(grammarAccess.getStmtAccess().getNode1Assignment_8_3(), "rule__Stmt__Node1Assignment_8_3");
					put(grammarAccess.getStmtAccess().getNode2Assignment_8_5(), "rule__Stmt__Node2Assignment_8_5");
					put(grammarAccess.getStmtAccess().getStmtAssignment_8_7(), "rule__Stmt__StmtAssignment_8_7");
