...
public class AnnexDMPLGeneratorAction extends AbstractInstanceOrDeclarativeModelReadOnlyAction {
	...
	protected void analyzeInstanceModel(IProgressMonitor monitor, final AnalysisErrorReporterManager errManager,
		...
		final String targetFilename = getStringPropertyValue(root, "DMPLProperties", "DMPL_Target_File");
		final String missionFilename = getStringPropertyValue(root, "DMPLProperties", "DMPL_Mission_File");
